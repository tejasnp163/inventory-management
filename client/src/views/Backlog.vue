    ...
    <div v-else>
      <div class="stats-grid">
        <div class="stat-card danger">
          ...
          <div class="stat-value">{{ priorityCounts['high'] || 0 }}</div>
        </div>
        <div class="stat-card warning">
          <div class="stat-label">{{ t('priority.medium') }}</div>
          <div class="stat-value">{{ priorityCounts['medium'] || 0 }}</div>
        </div>
        <div class="stat-card info">
          <div class="stat-label">{{ t('priority.low') }}</div>
          <div class="stat-value">{{ priorityCounts['low'] || 0 }}</div>
        </div>
        <div class="stat-card">
...
export default {
  ...
  setup() {
    ...
    const priorityCounts = computed(() =>
      backlogItems.value.reduce((acc, i) => {
