...
const loadData = async () => {
  try {
    loading.value = true
    error.value = null
    // Reports API doesn't accept filter params, but we watch filters for consistency
...
// Watch global filters for consistency with rest of app (Reports API ignores them server-side)
